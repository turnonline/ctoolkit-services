 ...
 * <li><b>Task Name:</b> a name of the job, composition of the name prefix and entity ID.
 * If name prefix is not defined, task name will be auto generated by the App Engine.</li>
        ...
        implements DeferredTask
{
    ...
    /**
     * Returns the task name as a composition of the non null name prefix and entity ID.
