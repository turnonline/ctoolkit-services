        ...
        extends GoogleOAuth2Authenticator
{
     ...
     * Once passes, it will return instance of {@link VerifiedUser} and its properties are mapped as following:
     * <ul>
     ...
     * <li>{@link VerifiedUser#getId()} populated from the request header {@link #ON_BEHALF_OF_USER_ID},
     ...
     * <li>{@link VerifiedUser#getServiceAccount()} the email address of the default service account,
     ...
     * <p>
     * The final {@link VerifiedUser} is available as request attribute:
     * <p>
